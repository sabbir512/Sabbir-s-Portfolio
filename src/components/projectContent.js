...
const classesForIcons = {
  divClass: `lagerThenLg:w-[55px] lagerThenLg:h-[55px] rounded-lg bg-[#3E73DB] flex lg:w-[50px] lg:h-[50px] md:w-[40px] md:h-[40px] sm:w-[35px] sm:h-[35px]  mediumPhone:w-[40px] mediumPhone:h-[40px] smallerPhone:w-[30px] smallerPhone:h-[30px] ease-in duration-500 hover:bg-purple-300`,
